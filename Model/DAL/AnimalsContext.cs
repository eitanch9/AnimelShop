    ...
    public class AnimalsContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Comment>().HasData(
                 new { CommentText = "It is a type of predator in the canine family", AnimalId = 1, CommentId = ++id },
                 new { CommentText = "The dogs' sense of smell is particularly developed", AnimalId = 1, CommentId = ++id },
